...
export const state = () => ({
  items: [
    ...
    { title: 'MacBook Pro 16', category: 'laptops', price: 199990, id: 19, specs: ['Экран: 16 дюймов, 3072x1920, широкоформатный', 'Видеокарта: AMD Radeon Pro 5500M', 'Конфигурация накопителей: SSD', 'Процессор: Intel Core i9, Intel Core i9 9880H 2300 МГц', 'Память: 16 ГБ DDR4 2666 МГц'], src: '/macbook.jpg', hot: true },
